...
const HeroSection = () => {
    ...
    useEffect(() => {
        const timer: NodeJS.Timeout = setTimeout(() => setTextVisible(true), 500);
            ...
            <div className="text-center z-10 px-6">
                ...
                >
                    <h1 className="text-6xl md:text-9xl font-black mb-6 tracking-tight">
                        ...
                        <br />
                        <span className="text-white/50">Without Limits</span>
                    </h1>

                    <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
                        Professional image editing powered by AI. Crop, resize, adjust colors,
                        remove backgrounds, and enhance your images with cutting-edge technology.
                    </p>
                    ...
                    <div className="backdrop-blur-lg bg-white/10 border border-white/20 rounded-3xl p-6 transform-gpu">
                        <div className="bg-linear-to-r from-slate-900 to-slate-800 rounded-2xl p-8 min-h-96">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <div className="text-gray-400 text-sm">PixelForge Pro</div>
                            </div>
